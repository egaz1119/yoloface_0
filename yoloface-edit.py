...
parser.add_argument('--model-cfg', type=str, default='./cfg/yolov3-tiny_obj2.cfg',
                    help='path to config file')
parser.add_argument('--model-weights', type=str,
                    default='./model-weights/yolov3-tiny_obj2_last.weights',
...
def _main():
    ...
    while True:
        ...
        if not has_frame:
            ...
            #print('Output file is stored at', os.path.join(args.output_dir, output_file))
            cv2.waitKey(1000)
            break
